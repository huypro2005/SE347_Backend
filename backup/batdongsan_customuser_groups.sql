...
CREATE TABLE `customuser_groups` (
  ...
  CONSTRAINT `accounts_customuser__customuser_id_bc55088e_fk_accounts_` FOREIGN KEY (`customuser_id`) REFERENCES `customuser` (`id`),
...
-- Dump completed on 2025-12-13  0:38:15
