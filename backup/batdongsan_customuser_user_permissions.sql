...
CREATE TABLE `customuser_user_permissions` (
  ...
  CONSTRAINT `accounts_customuser__customuser_id_0deaefae_fk_accounts_` FOREIGN KEY (`customuser_id`) REFERENCES `customuser` (`id`),
...
-- Dump completed on 2025-12-13  0:38:27
